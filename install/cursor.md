...
- `mini`：把 `dist/short-fiction-humanizer-mini.md` 粘贴进单次聊天或临时 Rule。适合上下文很紧、较弱模型或只清明显模板感。
...
cp SKILL.md .cursor/rules/short-fiction-humanizer.md

# Windsurf
mkdir -p .windsurf/rules
cp SKILL.md .windsurf/rules/short-fiction-humanizer.md
```
