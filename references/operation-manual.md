...
- `拖 / 耗 / 欠 / 逼 / 管 / 接 / 靠 / 等 / 陪 / 救` 等动词后只有一个泛化代词或语气词，读者仍不知道对象、方式、范围或后果
- `我不拖你`、`我不欠你`、`我不逼你`、`这事我不管`、`这单我接` 说得像承诺，却没有可核对的动作
- 句子删掉后，人物的具体选择和责任变化仍无法判断

### 默认动作

- 补出原文已有的对象、方式、范围或结果：`我不再占着你的时间，十分钟内回话`
- 原文没有可补的信息时，改写成具体动作或后果，不凭空增加金额、期限、关系或承诺：`他把单子推回去，没替她签字`
- 先做语义核对，再决定是否保留口语省略；不要为了完整而补出原文没有的事实

### 保留条件

- 上下文已明确对象、方式和结果，省略不会造成误解
- `靠！` 等独立感叹词，或 `靠着墙 / 靠这笔钱过冬` 等对象明确的字面用法
- 引用原文、方言或人物刻意留下的停顿，且读者能从现场补全

### 回读检查

- 谁对什么做了什么，是否能从句子或紧邻上下文直接回答
- 动作做到哪一步、造成什么后果，是否仍然悬空
- 是否为了补完整而擅自新增金额、期限、对象、关系或责任

## 10.2 硬伤优先复查

### 识别信号

- 局部句子有生活感，但对白、物件、行动链或情绪落点仍然不成立
- 同一时间/动作/检查句在同一节重复，像剪辑残留
- 前文已经尝试并失败的动作，后文又无解释地重新提出
- 菜品、容器、数量或空间尺度互相冲突；或“订好了”一类词把生活场面写成会议安排
- 悲伤、紧张或揭示正在收束时，突然插入无关的可爱、装饰或环境细节
- “手机提示某人发来……”把现场写成通知栏，人物与正在做的事被切断

### 默认动作

1. 先修硬伤：补足或删除不生活的对白，纠正物件与场景的尺度/质感，删除重复句，修正行动先后和失败后的选择；
2. 再修搭配：把会议式名词换成正在发生的动作，如占桌、发照片、菜已下锅；
3. 最后才处理句长、感官和模板词。不要用新增素材或漂亮话掩盖硬伤。

### 保留条件

- 重复确实是有意复沓，且改变了语气、视角或信息；
- 奇幻、荒诞或人物刻意的错配有明确设定或喜剧功能；
- 通知句属于系统界面或消息列表格式，且格式本身是受保护的叙事设备。

### 回读检查

- 每个动作是否只有一个可成立的前后顺序，失败尝试是否影响后续选择；
- 物件是否符合菜品、数量、温度和空间的实际质感；
- 情绪收束段删掉抢戏细节后，主情绪是否更集中；
- 消息事实是否保留，但通知栏式设备拟人和说明口吻是否已压掉。
